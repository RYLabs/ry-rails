...
# MIGRATION
  ...
  # migration_template "add_authentication_token_to_users.rb",
  #   "#{migration_path}/add_authentication_token_to_users.rb",
  #   migration_version: "[#{Rails::VERSION::MAJOR}.#{Rails::VERSION::MINOR}]"

  # app_schema.rb
  insert_into_file "app/graphql/#{app_name.underscore}_schema.rb",
    "  context_class(#{app_name.classify}Context)\n",
    after: /query\(Types::QueryType\)\n/

  # graphql_controller.rb
  insert_into_file 'app/controller/graphql_controller.rb', "  include APIContext\n", after: /< ApplicationController\n/
  gsub_file 'app/controller/graphql_controller.rb', /context = \{.*?\}/m, 'context = build_api_context'
